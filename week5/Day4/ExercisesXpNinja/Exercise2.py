...
class Game():
    def start(self):
        ...
        for i in range(num):
            ...
            file = f"C:/Users/ZONA/3D Objects/Orange DI/DI-Bootcamp/week5/Day4/ExercisesXpNinja/{character.name}.txt"   
        ...
        json_file = "C:/Users/ZONA/3D Objects/Orange DI/DI-Bootcamp/week5/Day4/ExercisesXpNinja/players.json"
